...
public class Today24HourView extends View {
    ...
    private static int ITEM_SIZE = 24;  //24小时
    ...
    private int maxScrollOffset = 2480;//滚动条最长滚动距离
...
//            3, 5, 5, 5};
    ...
    private void initHourItems() {
        ...
        for (int i = 0; i < ITEM_SIZE * 3; i++) {
            ...
            Point point = calculateTempPoint(left, right, temp);
...
//        System.out.println("maxScrollOffset---lalal:" + maxScrollOffset);
